...
(function ($) {
    ...
    $.fn.jRoom = function (options) {
        ...
        function createCube(width, height) {
            ...
            var
                front = $('<div class="' + settings.cubeClass + '-front"></div>'),
                back = $('<div class="' + settings.cubeClass + '-back"></div>'),
                left = $('<div class="' + settings.cubeClass + '-left"></div>'),
                right = $('<div class="' + settings.cubeClass + '-right"></div>'),
                top = $('<div class="' + settings.cubeClass + '-top"></div>'),
                bottom = $('<div class="' + settings.cubeClass + '-bottom"></div>');
