...
d(h,i),e(h,i)}var k,l=this,m=void 0!==document.ontouchmove,n=a.extend(!0,{wallWidth:300,wallHeight:300,cube:{front:"white",back:"white",left:"#d3d3d3",right:"#d3d3d3",top:"#f3f3f3",bottom:"#ddd"},attach:{front:"",back:"",left:"",right:"",top:"",bottom:""},cubeClass:"room-cube",perspectiveRate:1,viewLimit:{xMin:-15,xMax:15,yMin:-360,yMax:360}},b);return function(){j(),a(window).on("resize",function(){j()}),k.jTouch({viewLimit:n.viewLimit||{xMin:-10,xMax:10},keyDelta:1})}(),l.getCube=function(){return k},l}}(jQuery);